<div class="row">
        <div class="col-md-6">
            <div class="form-group required">
                     ...
                     <input name="name" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" value="{{ old('name') ?? $customer->name }}" onfocusout="validateName()">
                         @if ($errors->has('name'))
            ...
            <div class="form-group row">
                <label for="address">Address</label>
                     ...
                     <input name="address" type="text" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" id="address" value="{{ old('address') ?? $customer->address}}" onfocusout="validateAddress()">
            ...
            <div class="form-group row">
                <label for="officenumber"> Office No</label>
                     ...
                     <input name="officenumber" type="text" class="form-control {{ $errors->has('officenumber') ? ' is-invalid' : '' }}" id="officenumber" value="{{ old('officenumber') ?? $customer->officenumber}}" onfocusout=" validateOfficenumber()">
