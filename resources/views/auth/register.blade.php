				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="info d-flex align-items-center">
							<div class="content">
								<div class="logo">
									<div class="avatar text-center"><img src="/img/logo.png" alt="TIMSLogo" class="img-fluid" width="350" height="350">
									</div>
									<div class="title">
								...
								<div class="card">
									...
									<div class="card-body">
                                        ...
                                        <strong>{{ $errors->first('name') }}</strong>
											...
											<div class="form-group required">
												<label for="email" class="control-label col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                                        ...
                                        <strong>{{ $errors->first('email') }}</strong>
											...
											<div class="form-group required">
												<label for="password" class="control-label  col-form-label text-md-right">{{ __('Password') }}</label>
                                        ...
                                        <strong>{{ $errors->first('password') }}</strong>
											...
											<div class="form-group required">
												<label for="password-confirm" class="control-label  col-form-label text-md-right">{{ __('Confirm Password') }}</label>
