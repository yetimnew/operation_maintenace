...
<div class="row col-12">
	...
	<div class="col-2">
		...
		{{-- <button class="btn btn-default pull-right" onclick="exportTableToExcel('statuses', 'members-data')"><img src="../img/xls.png" width="24" class="mr-2">Export To Excel</button> --}}
	</div>
</div>
<div class="row col-12">
