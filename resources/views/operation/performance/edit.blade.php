...
<div class="col-md-12">
	...
	<div class="card text-left">
		<div class="card-header">
			<h2>Performance Update of FO <span class="text text-danger"> {{$performance->FOnumber}} </span></h2> </div>
		<div class="card-body">
			<form method="POST" action="{{route('performace.update',['id'=>$performance->id])}}" class="form-horizontal" id="performance_edit_form" novalidate>
				@csrf
			@include('operation.performance.form')
							...
							<div class="form-group">
								...
								<div class="input-group"> <span class="input-group-addon"></span>
									<input name="r_date" type="date" class="form-control {{ $errors->has('r_date') ? ' is-invalid' : '' }}" id="r_date"  value="{{ old('r_date') ?? $performance->returned_date}}">
